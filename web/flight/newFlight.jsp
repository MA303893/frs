...
<div class="container">
    ...
    <form action="/flights/new" method="post">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="flightName" name="flightName" placeholder="Flight Name"
                       required
                >
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" id="seatingCapacity" name="seatingCapacity"
                       placeholder="Flight Seating Capacity" required
                >
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" id="reservationCapacity" name="reservationCapacity"
                       placeholder="Flight Reservation Capacity" required>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-10">
